...
def secured_str(string):
    """
    From the argument string, returns a string that can be used as a string without any further precaution regarding presence of: simple quotes, double quotes, apostrophes, etc.
    tbd baz
    """
    pass
